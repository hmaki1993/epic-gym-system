...
export default function Settings() {
    ...
    const applyThemeStyles = (themeId: string) => {
        ...
        if (themeId === 'dark') {
            ...
            root.style.setProperty('--color-secondary', '#1e293b'); // Dark blue/slate
            root.style.setProperty('--color-background', '#0f172a'); // Very dark blue
            root.style.setProperty('--color-surface', '#1e293b'); // Dark slate for cards
            root.style.setProperty('color', '#f8fafc'); // Light text
