                                    ...
                                    <div className="group z-30">
                                        ...
                                        <div className="flex gap-3 relative">
                                            <div className="relative group/dropdown">
                                                <button type="button" className="h-full pl-4 pr-3 bg-[#0E1D21] border border-[#677E8A]/15 rounded-[2rem] flex items-center gap-2 hover:border-[#622347] transition-all min-w-[110px]">
                                                    ...
                                                    <ChevronDown className="w-3 h-3 text-[#677E8A]/50 group-hover/dropdown:text-[#622347] transition-colors" />
                                                </button>
                                                <div className="absolute top-[110%] left-0 w-64 bg-[#0B1518]/95 backdrop-blur-xl border border-[#677E8A]/20 rounded-2xl overflow-hidden hidden group-hover/dropdown:block shadow-2xl max-h-64 overflow-y-auto no-scrollbar z-50">
                                                    {COUNTRIES.map(c => (
                                                        <button key={c.code} type="button" onClick={() => setFormData({ ...formData, country_code_student: c.dial_code })} className="flex items-center gap-3 w-full px-5 py-4 hover:bg-[#622347]/10 transition-all text-left border-b border-white/5 last:border-0 group/item">
                                                            ...
                                                            <span className="text-[10px] font-black text-[#622347]">{c.dial_code}</span>
                                                        </button>
                                                    ))}
                                                </div>
                                            </div>
