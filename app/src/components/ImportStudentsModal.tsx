...
export default function ImportStudentsModal({ isOpen, onClose, onSuccess }: ImportStudentsModalProps) {
    ...
    const validateRow = (row: CSVRow, index: number): ParsedStudent => {
        ...
        // Subscription type validation (Simplified for import)
        // Note: Real validation happens against DB plans during insertion if needed
                ...
                try {
                    ...
                    const isDuplicate = existingStudents?.some(existing =>
                        ...
                        (existing.contact_number?.trim() === student.phone?.trim() ||
                            existing.parent_contact?.trim() === student.phone?.trim())
                    );
                                ...
                                <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-[9px] font-bold text-white/20 italic">Contact Number</span>
                                        </div>
                                    </div>
                                </div>
